...
import car_logo from './static/img/car_logo.png';
import './style.scss';
export class MainNav extends React.Component {
	...
	render () {
		return (
				<nav id="main-nav" className="navbar navbar-expand-lg navbar-light  sticky-top" style={{padding : 'unset', height: '65px'}}>
			    <Link to={"/CarRental/"} className="navbar-brand pl-5 linkstyle">
			      <img src={car_logo} alt="Logo" style={{width:200}}/>
			    </Link>
