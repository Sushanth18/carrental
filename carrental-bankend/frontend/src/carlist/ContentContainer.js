...
class ContentContainer extends React.Component {
	...
	vehiclesToTableRow = vehicles=>{
			...
			const vehicleParameters=vehicles.vehicleParameters;
			return <CarItem key={id} id={id} name={name} brand={brand} model={model} dailyFee={dailyFee} description={description} photoName={photoName} vehicleParameters={vehicleParameters}/>;
	}
