...
export class MyAllRentedVehicles extends React.Component {
    ...
    setBookingList = (page,number) => {
      const url = "http://localhost:8080/CarRental/booking/rented/"+this.state.currentUserId+"?page="+page+"&number="+number;
