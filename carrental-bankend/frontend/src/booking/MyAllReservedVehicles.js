...
export class MyAllReservedVehicles extends React.Component {
    ...
    setBookingList = (page,number) => {
      const url = "http://localhost:8080/CarRental/booking/reserved/"+this.state.currentUserId+"?page="+page+"&number="+number;
