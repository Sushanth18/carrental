...
class UserTable extends React.Component {
  ...
  renderRow = (car) => {
    ...
    const urlChat = "/CarRental/profile/chat?vechileId="+car.id+"&type=owner";
    return(
      
      <tr key={car.id}>
        <td><Link to={urlChat} className="linkstyle btn btn-success custom-width">Chat With Renter</Link></td>
