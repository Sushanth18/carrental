...
public class VehicleFilterDto implements Serializable {
	...
	public VehicleFilterDto(String brand, String model, String city, String bodytype, BigDecimal priceFrom,
			BigDecimal priceTo, Integer placesNumberFrom, Integer placesNumberTo, Integer doorsNumberFrom,
			Integer doorsNumberTo, Integer productionYearFrom, Integer productionYearTo, String color) {
		super();
		this.brand = brand;
		this.model = model;
		this.city = city;
	...
	public String toString() {
		return "CarFilterWrapper [brand=" + brand + ", model=" + model + ", city=" + city + ", bodytype=" + bodytype
				+ ", priceFrom=" + priceFrom + ", priceTo=" + priceTo + ", placesNumberFrom=" + placesNumberFrom
				+ ", placesNumberTo=" + placesNumberTo + ", doorsNumberFrom=" + doorsNumberFrom + ", doorsNumberTo="
				+ doorsNumberTo + ", productionYearFrom=" + productionYearFrom + ", productionYearTo="
				+ productionYearTo + ", color=" + color + "]";
	}
